export type ConversationTurn={id:string;characterId:string;speaker:'player'|'character';text:string;createdAt:number;topicKey?:string}
...
export function appendConversationTurn(history:ConversationHistory,turn:ConversationTurn,_maxTurns=24):ConversationHistory{
 ...
 return {version:1,turns:[...history.turns,turn]}
}
