...
export type EntityId='voice-box'|'receipt'|'home-door'|'home-return'|'neighbor'|'caretaker'|'seal'|'service-door'|'clerk'|'ledger'|'choice-desk'|'service-exit'
...
export const entities:Record<EntityId,Entity>={
 ...
 neighbor:{id:'neighbor',scene:'hall',label:['等电梯的邻居','Neighbor by the lift'],approach:{x:133,y:256},visual:{x:125,y:222,w:20,h:32},obstacle:{x:126,y:230,w:18,h:20},kind:'person',actions:['talk-neighbor']},
 caretaker:{id:'caretaker',scene:'hall',label:['冷脸的值守人','Stern attendant'],approach:{x:244,y:279},visual:{x:250,y:245,w:20,h:32},obstacle:{x:251,y:252,w:18,h:20},kind:'person',actions:['talk-caretaker']},
 ...
 clerk:{id:'clerk',scene:'service',label:['窗口职员','Counter clerk'],approach:{x:178,y:242},visual:{x:177,y:181,w:22,h:36},obstacle:{x:177,y:193,w:22,h:25},kind:'person',actions:['talk-clerk']},
